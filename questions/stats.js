...
const QUESTIONS_STATS = [
  ...
  // ── Calculer une moyenne ──
  {
    ...
    bonneReponse: (v) => `$${((v.a + v.b + v.c + v.d) / 4).toFixed(1)}$`,
    distracteurs: (v) => [
      `$${v.a + v.b + v.c + v.d}$`,
      `$${Math.max(v.a, v.b, v.c, v.d)}$`,
      `$${((v.a + v.b + v.c + v.d) / 4 + 1).toFixed(1)}$`
    ]
  },
  ...
  // ── Médiane d'une série paire ──
  {
    ...
    enonce: (v) => `Médiane de la série ordonnée $${v.a} ; ${v.b} ; ${v.c} ; ${v.d}$`,
  ...
  // ── Médiane d'une série impaire ──
  {
    ...
    enonce: (v) => `Médiane de la série ordonnée $${v.a} ; ${v.b} ; ${v.c} ; ${v.d} ; ${v.e}$`,
    bonneReponse: (v) => `$${v.c}$`,
    distracteurs: (v) => [
      `$${v.b}$`,
      `$${v.d}$`,
  ...
  // ── Premier quartile Q1 ──
  {
    ...
    enonce: (v) => `Série : $${v.a};${v.b};${v.c};${v.d};${v.e};${v.f}$. Quel est $Q_1$ ?`,
    bonneReponse: (v) => `$${(v.b + v.c) / 2}$`,
    distracteurs: (v) => [
      `$${v.b}$`,
      `$${v.a}$`,
  ...
  // ── Étendue d'une série ──
  {
    ...
    enonce: (v) => `Série $${v.a};${v.b};${v.c};${v.d}$. Quelle est l'étendue ?`,
